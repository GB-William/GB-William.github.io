...
const translations = {
  fr: {
    ...
    'projects.p3.title': "Gestion des dossiers d'urbanisme",
    'projects.p3.desc':  "Application de suivi des autorisations d'urbanisme (permis de construire, déclarations, certificats) avec numérotation automatique sécurisée et gestion des dossiers modificatifs.",
    'projects.p3.client':'Mairie de Longeville-lès-Metz — Stage',
    'xp.label':          'Parcours',
    ...
    'xp.item2.desc':     "Développement de deux applications métier : gestion du courrier et gestion des dossiers d'urbanisme (AOS). Stack : PHP · MariaDB · Docker · JavaScript.",
    'xp.item4.title':    'Conseiller Municipal',
    'xp.item4.company':  'Mairie de Longeville-lès-Metz',
    'xp.item4.desc':     'Élu au conseil municipal — participation aux séances plénières et aux commissions thématiques de la ville.',
    ...
    '404.desc':          'Cette page n\'existe pas ou a été déplacée.',
  ...
  en: {
    ...
    'projects.p3.title': 'Urban Planning Permit Tracking',
    'projects.p3.desc':  'Application for tracking urban planning applications (building permits, declarations, certificates) with secure automatic numbering and modification tracking.',
    'projects.p3.client':'Longeville-lès-Metz City Hall — Internship',
    'xp.label':          'Experience',
    ...
    'xp.item2.desc':     'Built two business applications: mail management and urban planning permit tracking (AOS). Stack: PHP · MariaDB · Docker · JavaScript.',
    'xp.item4.title':    'City Council Member',
    'xp.item4.company':  'Longeville-lès-Metz City Hall',
    'xp.item4.desc':     'Elected to the city council — attending plenary sessions and contributing to municipal commissions.',
    ...
    '404.desc':          'This page does not exist or has been moved.',
